...
export default function Signin() {
    ...
    return (
        <div id="signin" className="pt-20 bg-gray-900 flex items-center justify-center flex-col min-h-screen">

            <div className={`${loader} absolute top-48 items-center justify-center text-white`}>
                <AuthLoader />
            ...
            <label className="text-white block mb-2 text-sm font-medium dark:text-white">Your Password</label>
            <div className="relative mb-6">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
